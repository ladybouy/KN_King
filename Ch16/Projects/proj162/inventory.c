...
void update(void);
void print(void);
void selection_sort(struct part array[], int elements);
...
void print(void)
{
    ...
    selection_sort(inventory, num_parts);
...
void selection_sort(struct part array[], int elements)
{
    ...
    for (int i = 0; i < elements; i++) {
        if (array[i].number > array[largest].number) {
            largest = i;
        }
    }

    struct part temporary = array[largest]; 
